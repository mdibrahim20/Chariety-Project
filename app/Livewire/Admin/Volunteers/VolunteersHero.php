...
use App\Services\VolunteersHeroService;
use Livewire\Attributes\Layout;
use Livewire\Component;
use Livewire\WithFileUploads;

#[Layout('layouts.admin')]
class VolunteersHero extends Component
{
    use WithFileUploads;

    protected VolunteersHeroService $service;
    ...
    public function boot(VolunteersHeroService $service): void
    {
    ...
    public function save(): void
    {
        try {
            $this->validate([
                ...
                'breadcrumb_current_label' => 'nullable|string|max:255',
            ...
            session()->flash('success', 'Volunteers hero section updated successfully!');
        } catch (\Exception $e) {
            \Log::error('Volunteers hero save error: ' . $e->getMessage());
    ...
    public function deleteBackgroundImage(): void
    {
        try {
            ...
            session()->flash('success', 'Background image deleted!');
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.admin.volunteers.volunteers-hero');
    }
}
