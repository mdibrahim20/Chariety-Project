...
use App\Services\FaqHeroService;
...
class FaqHero extends Component
{
    ...
    public function mount(FaqHeroService $service)
    {
    ...
    public function save(FaqHeroService $service)
    {
        $this->validate();
        ...
        session()->flash('success', 'FAQ Hero section updated successfully!');
        $this->redirect('/admin/faq/hero', navigate: true);
    }

    public function deleteImage(FaqHeroService $service)
    {
    ...
    {
        return view('livewire.admin.faq.faq-hero')
            ->layout('layouts.app');
    }
}
