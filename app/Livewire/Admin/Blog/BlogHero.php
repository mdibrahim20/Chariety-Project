...
use App\Services\BlogHeroService;
...
class BlogHero extends Component
{
    ...
    protected BlogHeroService $service;
    ...
    public function boot(BlogHeroService $service): void
    {
    ...
    public function save(): void
    {
        try {
            ...
            session()->flash('success', 'Blog hero section updated successfully!');
        } catch (\Exception $e) {
            \Log::error('Blog hero save error: ' . $e->getMessage());
    ...
    {
        return view('livewire.admin.blog.blog-hero');
    }
}
