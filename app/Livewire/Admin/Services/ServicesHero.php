...
use App\Services\ServicesHeroService;
...
class ServicesHero extends Component
{
    ...
    protected ServicesHeroService $service;
    ...
    public function boot(ServicesHeroService $service): void
    {
    ...
    public function save(): void
    {
        try {
            ...
            session()->flash('success', 'Services hero section updated successfully!');
        } catch (\Exception $e) {
            \Log::error('Services hero save error: ' . $e->getMessage());
    ...
    {
        return view('livewire.admin.services.services-hero');
    }
}
