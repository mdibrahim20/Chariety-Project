...
class FaqHeroService
{
    const HERO_WIDTH = 1920;
    const HERO_HEIGHT = 600;
    const MAX_FILE_SIZE = 500 * 1024;

    public function getSection(): FaqHeroSection
    {
        return FaqHeroSection::firstOrCreate(
            [],
            [
                'page_title' => 'FAQ\'s',
                'breadcrumb_home_label' => 'Home',
                'breadcrumb_current_label' => 'FAQ\'s',
                'is_active' => true,
    ...
    public function updateSection(array $data): FaqHeroSection
    {
