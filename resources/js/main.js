...
(function($) {
    ...
    $('#testimoni1').owlCarousel({
        ...
        navText: ['<img src="/img/icons/vl-arrow-left-1.1.svg" alt="">', '<img src="/img/icons/vl-angle-right-1.2.svg" alt="">'],
        responsive: {
            0: {
                items: 1,
            },
    ...
    $('#team1').owlCarousel({
        ...
        navText: ['<img src="/img/icons/vl-tem-left-arrow-1.1.svg" alt="">', '<img src="/img/icons/vl-team-right-1.2.svg" alt="">'],
        responsive: {
            0: {
                items: 1,
            },
    ...
    // $('.slider-nav1 .slick-slide').css('margin-left', '15px');
