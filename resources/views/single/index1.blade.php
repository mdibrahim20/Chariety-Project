...
@section('content')
                        ...
                        <div class="col-lg-7">
                            <div class="vl-hero-section-title">
                                ...
                                <div class="vl-hero-btn">
                                    <a href={{ route('second', ['pages', 'contact']) }} class="header-btn1">Join The Relief Effort <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
    ...
    <!--===== ABOUT AREA STARTS =======-->
    <section id="about" class="vl-about-section sp2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-2 col-md-6 mb-30">
                    <div class="vl-about-sm-content" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300">
                        ...
                        <div class="btn-area">
                            <a href={{ route('second', ['pages', 'team']) }} class="header-btn1">Volunteer <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
    ...
    <!--===== Causes AREA STARTS =======-->
    <section id="cause" class="vl-causes-area sp2">
        <div class="container">
    ...
    <!--===== Event AREA STARTS =======-->
    <section id="event" class="vl-blog sp2">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="vl-blog-lar-thumb-bg mb-30" style="background-image: url(/img/blog/vl-blog-larg-thmb.png);">
                        <div class="vl-section-title-1">
                            ...
                            <div class="btn-area" data-aos="fade-right" data-aos-duration="800" data-aos-delay="300">
                                <a href={{ route('second', ['events', 'single']) }} class="header-btn1">Vineyard Venues <span><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-8">
                                        <div class="vl-single-blog-box-content">
                                            ...
                                            <h4 class="title"><a href={{ route('second', ['events', 'single']) }}>Unity Giving Community <br> Charity Event</a></h4>
                                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="sm-thumb">
                                            <a href={{ route('second', ['events', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-sm-thumb-1.1.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-8">
                                        <div class="vl-single-blog-box-content">
                                            ...
                                            <h4 class="title"><a href={{ route('second', ['events', 'single']) }}>Spread the Love Charity <br> Art Exhibition</a></h4>
                                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="sm-thumb">
                                            <a href={{ route('second', ['events', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-sm-thumb-1.2.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="vl-single-blog-box mb-20">
                                <div class="row">
                                    <div class="col-lg-8 col-md-8">
                                        <div class="vl-single-blog-box-content">
                                            <span class="date"><img src="/img/icons/vl-clock-1.1.svg" alt="">11:00 AM</span>
                                            <h4 class="title"><a href={{ route('second', ['events', 'single']) }}>Shine for a Cause Charity Dinner & Auction</a></h4>
                                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="sm-thumb">
                                            <a href={{ route('second', ['events', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-sm-thumb-1.3.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section id="testimonial" class="vl-testimonial vl-testimonial-bg sp1">
        <div class="container">
    ...
    <!--===== Gallery AREA STARTS =======-->
    <section id="gallery" class="vl-gallery sp2">
        <div class="container">
    ...
    <!--===== Team AREA ENDS =======-->
    <section id="volunteer" class="vl-team-bg-1 sp1">
        <div class="container">
                ...
                <div id="team1" class="owl-carousel owl-theme">
                    ...
                    <div class="vl-team-parent">
                        ...
                        <div class="vl-team-content text-center">
                            <a href={{ route('second', ['pages', 'team']) }} class="title">Anita Gusikowski</a>
                    ...
                    <div class="vl-team-parent">
                        ...
                        <div class="vl-team-content text-center">
                            <a href={{ route('second', ['pages', 'team']) }} class="title">Samuel Corwin</a>
                    ...
                    <div class="vl-team-parent">
                        ...
                        <div class="vl-team-content text-center">
                            <a href={{ route('second', ['pages', 'team']) }} class="title">Hilda Wunsch</a>
                            <span>Volunteer</span>
                        </div>
                    </div>
    ...
    <!--===== Blog AREA ENDS =======-->
    <section id="blog" class="vl-blg sp2">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="300">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blg-1.1.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Stories from the Field: Firsthand <br> Accounts of Disaster Relief</a></h3>
                            <p>Get inside look at the real-life experiences of <br> our teams ground from emergency response.</p>
                            <a href={{ route('second', ['blogs', 'single']) }} class="read-more">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div><!-- single blog end -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blg-1.2.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2023</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Tips for Disaster Preparedness: How <br> to Stay Safe and Ready</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30" data-aos="fade-left" data-aos-duration="800" data-aos-delay="300">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blg-1.3.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2023</a></li>
