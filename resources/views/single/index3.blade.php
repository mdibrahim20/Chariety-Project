...
@section('content')
    ...
    <!--===== ABOUT AREA STARTS =======-->
    <section id="about" class="vl-about3 sp2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
    ...
    <div id="testimonial" class="testimonial3-section-area sp1 sp" style="background-image: url(/img/testimonial/testimonial-thumb-bg-3.3.png);">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto text-center">
                    <div class="heading2-w mb-60">
                        ...
                        <h2 class="testimonial-heading3 text-anime-style-3">Gratitude in Every Drop Water Aid Stories</h2>
                    </div>
                </div>
            </div>
    ...
    <!--===== FAQ AREA STARTS =======-->
    <section id="faq" class="vl-faq3 sp2">
        <div class="container">
            <div class="row">
    ...
    <!--===== Contact AREA STARTS =======-->
    <section id="contact" class="vl-contact3 sp2">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="vl-contact-from3" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                        ...
                        <p class="para">By reaching out, you’re taking first step toward making a difference <br> and joining a community committed to bringing safe, sustainable.</p>
                        <form action="#">
                            <div class="vl-form3">
                                <div class="row">
                                    <div class="col-lg-6">
    ...
    <!--===== Blog AREA STARTS =======-->
    <section id="blog" class="vl-blog3 sp2">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto">
                    <div class="vl-section-title3 mb-60 text-center">
