            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button
                        ...
                        type="button"
                        class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 {{ $overlay_enabled ? 'bg-indigo-600' : 'bg-gray-200' }}">
                        <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform {{ $overlay_enabled ? 'translate-x-6' : 'translate-x-1' }}"></span>
                    </button>
                </div>
                ...
                @if ($overlay_enabled)
                    ...
                    <div>
                        <label for="overlay_opacity" class="block text-sm font-medium text-gray-700 mb-2">
                            Overlay Opacity: <span class="font-bold text-indigo-600">{{ $overlay_opacity }}%</span>
                        </label>
                        <input
                            type="range"
                            id="overlay_opacity"
