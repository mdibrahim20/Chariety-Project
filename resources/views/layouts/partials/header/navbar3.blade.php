<!--=====HEADER START=======-->
<header>
    <div class="header-area homepage1 header-3 header header-sticky d-none d-lg-block mt-20" id="header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-elements header-elements-3">
                        <div class="site-logo">
                            <a href={{ route('any', 'index') }}><img src="/img/logo/vl-logo-3.1.png" alt=""></a>
                        </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn3 mb-20" href={{ route('any', 'index') }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn3" href={{ route('second', ['single', 'index1']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn3 mb-20" href={{ route('second', ['demo', 'index-2']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn3" href={{ route('second', ['single', 'index2']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn3 mb-20" href={{ route('second', ['demo', 'index-3']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn3" href={{ route('second', ['single', 'index3']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn3 mb-20" href={{ route('second', ['demo', 'index-4']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn3" href={{ route('second', ['single', 'index4']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn3 mb-20" href={{ route('second', ['demo', 'index-5']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn3" href={{ route('second', ['single', 'index5']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                        ...
                        <div class="vl-btn3">
                            <a href={{ route('second', ['pages', 'contact']) }} class="primary-btn-3">DONATE NOW</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="mobile-sidebar mobile-sidebar1">
    ...
    <div class="mobile-nav mobile-nav1">
        ...
        <div class="allmobilesection">
            <!-- btn -->
            <div class="vl-btn3 mb-30">
                <a href="#" class="primary-btn-3">DONATE NOW</a>
            </div>
