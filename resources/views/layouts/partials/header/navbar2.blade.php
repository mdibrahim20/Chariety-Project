<!--=====HEADER START=======-->
<header>
    <div class="header-area header-area2 homepage1 header header-sticky d-none d-lg-block " id="header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-elements header-elements-2">
                        <div class="site-logo">
                            <a href={{ route('any', 'index') }}><img src="/img/logo/vl-logo-2.1.png" alt=""></a>
                        </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn2 mb-20" href={{ route('any', 'index') }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn2" href={{ route('second', ['single', 'index1']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn2 mb-20" href={{ route('second', ['demo', 'index-2']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn2" href={{ route('second', ['single', 'index2']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn2 mb-20" href={{ route('second', ['demo', 'index-3']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn2" href={{ route('second', ['single', 'index3']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn2 mb-20" href={{ route('second', ['demo', 'index-4']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn2" href={{ route('second', ['single', 'index4']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                                                    ...
                                                    <div class="homemenu-thumb">
                                                        ...
                                                        <div class="homemenu-btn">
                                                            <a class="header-btn1 header-btn2 mb-20" href={{ route('second', ['demo', 'index-5']) }}>Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                            <a class="header-btn1 header-btn2" href={{ route('second', ['single', 'index5']) }}>One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                                        </div>
                        ...
                        <div class="home-btn-2">
                            <a href={{ route('second', ['pages', 'contact']) }} class="btn-2">Donate Now <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="col-12">
            <div class="mobile-header-elements">
                ...
                <div class="mobile-nav-icon mobile-nav-icon2 dots-menu">
    ...
    <div class="mobile-nav mobile-nav1">
        ...
        <div class="allmobilesection">
            ...
            <div class="vl-about-btn">
                <a href={{ route('second', ['pages', 'contact']) }} class="btn-primary2">Donate Now <span><i class="fa-solid fa-arrow-right"></i></span></a>
            </div>
