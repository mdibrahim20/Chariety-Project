        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner-1.2.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Partnering for Good: The Role of Collaboration in Crisis Relief</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner-1.3.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Stories of Change: Inspiring Journeys <br> and Community Impact</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner-1.5.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>"Making a Difference: Insights, News,<br> and Success Stories</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner-1.6.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Empowering Lives: Our Blog on Impact and Inspiration</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner1.7.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Inspiring Change: Stories of Hope, <br> Impact, and Compassion</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner1.8.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Building a Better Future: The Power <br> of Giving and Community Support</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-blg-item mb-30">
                        <div class="vl-blg-thumb">
                            <a href={{ route('second', ['blogs', 'single']) }}><img class="w-100" src="/img/blog/vl-blog-inner1.9.png" alt=""></a>
                        </div>
                        <div class="vl-meta">
                            <ul>
                                <li><a href="#"><span class="top-minus"> <img src="/img/icons/vl-calender-1.1.svg" alt=""></span> 16 October 2025</a></li>
                        ...
                        <div class="vl-blg-content">
                            <h3 class="title"><a href={{ route('second', ['blogs', 'single']) }}>Empowering Change: Stories, Insights, <br> and Updates from Our Mission</a></h3>
