@extends('layouts.base', ['title' => 'Cause'])
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-cause-box gray-bg mb-30">
                        ...
                        <div class="vl-cause-content">
                            ...
                            <a href="#" class="badge mt-32">Disasters</a>
                            <h3 class="title"><a href={{ route('second', ['causes', 'single']) }}>Help for the needy</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-cause-box gray-bg mb-30">
                        ...
                        <div class="vl-cause-content">
                            ...
                            <a href="#" class="badge mt-32">Disasters</a>
                            <h3 class="title"><a href={{ route('second', ['causes', 'single']) }}>Medical assistance</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="vl-single-cause-box gray-bg mb-30">
                        ...
                        <div class="vl-cause-content">
                            ...
                            <a href="#" class="badge mt-32">Disasters</a>
                            <h3 class="title"><a href={{ route('second', ['causes', 'single']) }}>Fees for victims</a></h3>
