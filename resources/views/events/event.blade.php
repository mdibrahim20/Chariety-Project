@extends('layouts.base', ['title' => 'Event'])
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href={{ route('second', ['events', 'single']) }} class="title">Empowerment through Giving Charity Ball</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href={{ route('second', ['events', 'single']) }} class="title">Spread the Love Charity Art Exhibition</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href={{ route('second', ['events', 'single']) }} class="title">Lives Golf Charity Networking Event</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href={{ route('second', ['events', 'single']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
                ...
                <div class="col-lg-12 mb-50">
                    <div class="event-bg-flex">
                        ...
                        <div class="event-content">
                            ...
                            <a href={{ route('second', ['events', 'single']) }} class="title">Shine for a Cause Charity Dinner & Auction</a>
                            <p class="para">Vineyard Venues 5396 North Reese Avenue, Fresno <br> CA 93722, Fresno CA, CA, United States</p>
                            <a href={{ route('second', ['events', 'right']) }} class="details">Event Details <span><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                        <div class="event-thumb">
