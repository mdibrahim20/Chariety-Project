...
<div <?php echo e($attributes->merge(['class' => 'mb-4'])); ?>>
    ...
    <input 
        ...
        <?php echo e($attributes->merge(['class' => 'w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ' . ($error ? 'border-red-500' : 'border-gray-300')])); ?>
...
<?php /**PATH I:\Helpy\resources\views\components\admin-input.blade.php ENDPATH**/ ?>