        ...
        <div class="flex items-center justify-between border-b border-gray-200 pb-4 mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    type="button"
                    class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 <?php echo e($section_is_active ? 'bg-indigo-600' : 'bg-gray-200'); ?>">
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform <?php echo e($section_is_active ? 'translate-x-6' : 'translate-x-1'); ?>"></span>
                </button>
                <span class="text-sm font-semibold <?php echo e($section_is_active ? 'text-green-600' : 'text-gray-500'); ?>">
                    <?php echo e($section_is_active ? 'Active' : 'Inactive'); ?>
            ...
            <div class="bg-gray-50 rounded-lg border border-gray-200 p-5 hover:shadow-md transition-shadow">
                ...
                <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <img src="<?php echo e(Storage::url($testimonial->avatar)); ?>" alt="<?php echo e($testimonial->reviewer_name); ?>" class="w-12 h-12 rounded-full object-cover border-2 border-gray-200">
                        <?php else: ?>
                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white font-bold text-lg">
                            <?php echo e(strtoupper(substr($testimonial->reviewer_name, 0, 1))); ?>

                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div>
                            <h3 class="font-semibold text-gray-900"><?php echo e($testimonial->reviewer_name); ?></h3>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->reviewer_role): ?>
                            <p class="text-xs text-gray-500"><?php echo e($testimonial->reviewer_role); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($testimonial->status === 'active' ? 'bg-green-100 text-green-800' : ($testimonial->status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800')); ?>">
                ...
                <div class="flex gap-1 mb-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                        <svg class="w-4 h-4 <?php echo e($i <= $testimonial->rating ? 'text-yellow-400 fill-current' : 'text-gray-300 fill-current'); ?>" viewBox="0 0 20 20">
                ...
                <blockquote class="text-sm text-gray-700 italic mb-4 line-clamp-4">
                    "<?php echo e($testimonial->review_text); ?>"
                </blockquote>

                
                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                    <span class="text-xs text-gray-500">Order: #<?php echo e($testimonial->display_order); ?></span>
                    <div class="flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($testimonial->status === 'pending'): ?>
                        <button
                            wire:click="approve(<?php echo e($testimonial->id); ?>)"
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <button
                            wire:click="openEditModal(<?php echo e($testimonial->id); ?>)"
                            class="text-indigo-600 hover:text-indigo-700 text-sm font-medium">
                            Edit
                        </button>
                        <button
                            wire:click="delete(<?php echo e($testimonial->id); ?>)"
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 rounded-t-lg">
                <div class="flex items-center justify-between">
                    <h3 class="text-xl font-bold text-white">
                        <?php echo e($editMode ? 'Edit Testimonial' : 'Add New Testimonial'); ?>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2 flex-wrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                ...
                                <svg class="w-10 h-10 <?php echo e($i <= $rating ? 'text-yellow-400 fill-current' : 'text-gray-300 fill-current'); ?> hover:text-yellow-300 transition-colors" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                                </button>
                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <span class="ml-2 text-sm text-gray-600 self-center"><?php echo e($rating); ?> star<?php echo e($rating > 1 ? 's' : ''); ?></span>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required></textarea>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['review_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['reviewer_role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <div class="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                <img src="<?php echo e($avatar->temporaryUrl()); ?>" alt="Preview" class="w-16 h-16 rounded-full object-cover border-2 border-indigo-500">
                                <div class="flex-1">
                                    <p class="text-sm font-medium text-gray-900"><?php echo e($avatar->getClientOriginalName()); ?></p>
                        ...
                        <?php elseif($existing_avatar): ?>
                        <div class="mb-3">
                            <div class="flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                <img src="<?php echo e(Storage::url($existing_avatar)); ?>" alt="Current" class="w-16 h-16 rounded-full object-cover border-2 border-gray-200">
                                <div class="flex-1">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col sm:flex-row items-center justify-end gap-3 rounded-b-lg">
                    ...
                    <button
                        ...
                        <span wire:loading.remove wire:target="save"><?php echo e($editMode ? 'Update' : 'Create'); ?></span>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH I:\Helpy\resources\views\livewire\admin\homepage\testimonials.blade.php ENDPATH**/ ?>