                        ...
                        <div class="vl-event-box-bg">
                            <div class="row">
                                ...
                                <div class="btn-area pb-32">
                                    <a href=<?php echo e(route('second', ['pages', 'contact'])); ?> class="header-btn1">Join This Event <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
...
<?php echo $__env->make('layouts.base', ['title' => 'Event Single'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Helpy\resources\views/events/single.blade.php ENDPATH**/ ?>