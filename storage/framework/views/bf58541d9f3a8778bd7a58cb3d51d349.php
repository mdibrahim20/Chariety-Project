                        ...
                        <div class="vl-search-widget mb-30">
                            ...
                            <div class="vl-rec-blog-flex">
                                ...
                                <div class="vl-rec-blog-content">
                                    ...
                                    <div class="vl-rec-blog-content-heading">
                                        <h3 class="tittle"><a href=<?php echo e(route('second', ['blogs', 'single'])); ?>>Stories from the Field:<br> Firsthand Accounts ....</a></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="vl-rec-blog-flex">
                                ...
                                <div class="vl-rec-blog-content">
                                    ...
                                    <div class="vl-rec-blog-content-heading">
                                        <h3 class="tittle"><a href=<?php echo e(route('second', ['blogs', 'single'])); ?>>Partnering for Good: <br> The Role of Collabor</a></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="vl-rec-blog-flex">
                                ...
                                <div class="vl-rec-blog-content">
                                    ...
                                    <div class="vl-rec-blog-content-heading">
                                        <h3 class="tittle"><a href=<?php echo e(route('second', ['blogs', 'single'])); ?>>Empowering Lives: <br> Our Blog on Impact ...</a></h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="vl-rec-blog-flex">
                                ...
                                <div class="vl-rec-blog-content">
                                    ...
                                    <div class="vl-rec-blog-content-heading">
                                        <h3 class="tittle"><a href=<?php echo e(route('second', ['blogs', 'single'])); ?>>Building a Better <br> Future: The Power...</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.base', ['title' => 'Blog Right'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Helpy\resources\views/blogs/right.blade.php ENDPATH**/ ?>