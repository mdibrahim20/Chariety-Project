...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'class' => 'w-6 h-6']));
...
foreach (array_filter((['name', 'class' => 'w-6 h-6']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH I:\Helpy\resources\views\components\admin-icon.blade.php ENDPATH**/ ?>