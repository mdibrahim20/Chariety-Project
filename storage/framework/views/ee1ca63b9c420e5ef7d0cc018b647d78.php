...
<?php $__env->startSection('header'); ?>
    <?php echo $__env->make('layouts.partials.header.navbar3', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
            ...
            <div class="row">
                <div class="col-lg-8 gx-0">
                    <div class="vl-section-heading3">
                        ...
                        <div class="vl-btn3">
                            <a href=<?php echo e(route('second', ['pages', 'contact'])); ?> class="primary-btn-3">Join The Relief Effort</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="vl-about-thumb-flex mb-30">
                        <a href=<?php echo e(route('any', 'about')); ?>><span><img src="/img/icons/vl-up-arrow.svg" alt=""></span></a>
                        <div class="row">
                    ...
                    <div class="vl-about-content-3 ml-50 mb-30">
                        <div class="vl-section-title3">
                            ...
                            <div class="vl-btn3" data-aos="fade-left" data-aos-duration="1100" data-aos-delay="300">
                                <a href=<?php echo e(route('second', ['events', 'event'])); ?> class="primary-btn-3">let's see work</a>
                            </div>
                        </div>
                    ...
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href=<?php echo e(route('second', ['pages', 'service'])); ?> class="title">Education Support</a>
                                <p class="para">Explore charity website discover impactful projects, opportunities.</p>
                                <a href=<?php echo e(route('second', ['pages', 'service'])); ?> class="rmore">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1100" data-aos-delay="300">
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href=<?php echo e(route('second', ['pages', 'service'])); ?> class="title">Healthy Foods</a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
                    <div class="vl-service-box-parent mb-30">
                        ...
                        <div class="vl-service-box-3">
                            ...
                            <div class="service-content">
                                <a href=<?php echo e(route('second', ['pages', 'service'])); ?> class="title">Medical Help</a>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="author-area">
                                    <div class="heading pl-20">
                                        <a href=<?php echo e(route('second', ['pages', 'team'])); ?> class="title">Leslie Alexander</a>
                    ...
                    <div class="vl-single-blog-item mr-15 mb-30">
                        ...
                        <div class="vl-blog-content">
                            ...
                            <div class="vl-content">
                                <a href=<?php echo e(route('second', ['blogs', 'single'])); ?> class="title">Innovative Solutions for Water Scarcity</a>
                                <p class="para">Learn about the latest technologies strategies <br> and partnerships that are helping us address.</p>
                                <a href=<?php echo e(route('second', ['blogs', 'single'])); ?> class="readmore">Read More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div> <!-- single blog end -->
                </div>
                ...
                <div class="col-lg-7 gx-0">
                    ...
                    <div class="vl-single-blog-item ml-15 mb-30">
                        ...
                        <div class="vl-blog-content">
                            ...
                            <div class="vl-content">
                                <a href=<?php echo e(route('second', ['blogs', 'single'])); ?> class="title">Clean Water, Healthy Futures: The Impact of Safe Water</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="vl-cta-content3 mb-30">
                            ...
                            <div class="cta-btn">
                                <a href=<?php echo e(route('second', ['pages', 'contact'])); ?> class="cta-btn1">Help Provide Water</a>
                                <a href=<?php echo e(route('second', ['pages', 'contact'])); ?> class="cta-btn2">Donate Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="vl-footer-widget-1 mb-30">
                        <div class="vl-footer-logo">
                            <a href=<?php echo e(route('second', ['demo', 'index-3'])); ?>><img src="/img/logo/vl-footer-logo-1.1.png" alt=""></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="vl-footer-widget-2 pl-90 mb-30">
                        ...
                        <div class="vl-footer-menu">
                            <ul>
                                <li><a href=<?php echo e(route('second', ['demo', 'index-3'])); ?>>Home Page</a></li>
                                <li><a href=<?php echo e(route('any', 'about')); ?>>About Us</a></li>
                                <li><a href=<?php echo e(route('second', ['pages', 'contact'])); ?>>Appointment</a></li>
...
<?php echo $__env->make('layouts.base', ['title' => 'Helpmore || 3', 'logo3' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Helpy\resources\views\demo\index-3.blade.php ENDPATH**/ ?>